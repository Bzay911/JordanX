...
@Composable
fun NikeScreen(navController: NavController, cartViewModel: CartViewModel) {

    // to initialise the products from firebase on the beginning
    LaunchedEffect(Unit){
        cartViewModel.fetchCartProductsFromFirebase("nike", "nikeShoes")
    }
